...
class Manicure extends Component {
  render () {
    return (
      <div className="Manicure middle flex-column" style={{
        paddingTop:"10em",
        paddingBottom:"10em"
      }}>
        <section className="container-fluid">
          <h3 className="display-3 middle">MANICURE</h3>
          <div style={{padding: "3em"}}>
            <p>
              Renew your appearance with ST Medi Spa Manicure! ST Medi Spa is a
